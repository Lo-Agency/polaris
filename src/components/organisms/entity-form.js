...
const EntityForm = ({ entityName, actionName, editID, formValues }) => {
	...
	return (
		<div className="top-0 absolute right-0 w-5/6">
			<form className="flex flex-col h-auto justify-center items-center w-5/6 mt-40" onSubmit={handleSubmit}>
				{fields}
				{error ? (
				...
				<Button
					className={
						'w-2/12 mt-10 flex justify-center items-center transition-colors text-white bg-black py-2 hover:text-gray-500'
					}
					loading={loading}
					actionName={actionName}
				/>
